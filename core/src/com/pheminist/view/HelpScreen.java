...
public class HelpScreen extends BaseScreen {
    private static final String text = " Данная версия программы находится в состоянии \"в принципе можно пользоваться\".\n" +
            ...
            "- если нужно репетируем. Нажатие на основной экран - пауза/продолжение, справа внизу слайдер, "+
            "кнопки перемотки в начало и на 5 секунд назад.\n"+
            ...
            "- в результате в корне в папке hrenaoke получаем файл типа имяисходногомидифайла_2_5.mp4 ,"+
